...
if (!url || !serviceKey) {
  throw new Error("Set NEXT_PUBLIC_SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY before seeding AI bots.");
}
...
const profiles = bots.map((bot) => ({
  ...
  pass_hash: "ai-bot-disabled-login",
  avatar_url: bot.avatarUrl,
  is_ai: true,
  ai_persona_type: bot.personaType,
  ai_persona_desc: bot.personaDesc,
  ai_display_label: bot.displayLabel,
  language: "zh-CN",
